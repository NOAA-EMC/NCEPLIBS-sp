...
C> @param[out] WAVE     - REAL (*) WAVE FIELD IF IDIR>0
C> @param[out] GRIDMN   - REAL GLOBAL MEAN IF IDIR<0
C> @param[out] GRIDX    - REAL (IMAX,JMAX) GRID X-GRADIENTS (E->W,N->S) IF IDIR<0
C> @param[out] GRIDY    - REAL (IMAX,JMAX) GRID Y-GRADIENTS (E->W,N->S) IF IDIR<0
