...
C> @param[out] GRIDMN   - REAL (KMAX) GLOBAL MEANS IF IDIR<0
C> @param[out] GRIDXN   - REAL (*) N.H. X-GRADIENTS (STARTING AT JBEG) IF IDIR<0
C> @param[out] GRIDXS   - REAL (*) S.H. X-GRADIENTS (STARTING AT JBEG) IF IDIR<0
C>                [GRIDX=(D(WAVE)/DLAM)/(CLAT*RERTH)]      
C> @param[out] GRIDYN   - REAL (*) N.H. Y-GRADIENTS (STARTING AT JBEG) IF IDIR<0
C> @param[out] GRIDYS   - REAL (*) S.H. Y-GRADIENTS (STARTING AT JBEG) IF IDIR<0
