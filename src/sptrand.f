C> @file
C>
C> Perform a gradient spherical transform
...
C> @param WAVE     - REAL (*) WAVE FIELDS IF IDIR>0
C> @param GRIDMN   - REAL (KMAX) GLOBAL MEANS IF IDIR<0
C> @param GRIDXN   - REAL (*) N.H. X-GRADIENTS (STARTING AT JBEG) IF IDIR<0
C> @param GRIDXS   - REAL (*) S.H. X-GRADIENTS (STARTING AT JBEG) IF IDIR<0
C> @param GRIDYN   - REAL (*) N.H. Y-GRADIENTS (STARTING AT JBEG) IF IDIR<0
C> @param GRIDYS   - REAL (*) S.H. Y-GRADIENTS (STARTING AT JBEG) IF IDIR<0
