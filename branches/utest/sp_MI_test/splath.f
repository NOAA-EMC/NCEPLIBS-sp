...
C 2012-08-21  IREDELL  USE GENERIC LUDCMP AND LUBKSB
C
...
C   LUDCMP       MATRIX FACTORIZATION
C   LUBKSB       MATRIX SOLVER
C
C ATTRIBUTES:
...
C$$$
      ...
      INTEGER,PARAMETER:: KD=SELECTED_REAL_KIND(25,45)
      REAL(KIND=KD):: PK(JMAX/2),PKM1(JMAX/2),PKM2(JMAX/2)
      REAL(KIND=KD):: SLATD(JMAX/2),SP,SPMAX,EPS=1.E9*EPSILON(SP)
      PARAMETER(JZ=50)
      REAL BZ(JZ)
